...
export declare class NgxEditorComponent implements ControlValueAccessor, OnInit, OnDestroy, OnChanges {
    ...
    static ɵcmp: ɵngcc0.ɵɵComponentDefWithMeta<NgxEditorComponent, "ngx-editor", never, { "placeholder": "placeholder"; "editable": "editable"; "outputFormat": "outputFormat"; "customMenuRef": "customMenuRef"; }, { "init": "init"; "focusOut": "focusOut"; "focusIn": "focusIn"; }, never, never>;
}
